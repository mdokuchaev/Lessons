...
public class Task8 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < massInt.length; i++) {
            if (massInt[i] > maxElement) {
                maxElement = massInt[i]; // максимальное значение
            }
            if (massInt[i] >= 0) {
        ...
        System.out.println("Максимальное значение в массиве: " + maxElement);
